...
def find_paths_from(cave_name, paths, visit_counter):
    ...
    for adjacent_cave_name in CAVE_MAP[cave_name]:
        ...
        if adjacent_cave_name == 'end':
            ...
            find_paths_from(adjacent_cave_name, paths, visit_counter)
    paths.pop()
    visit_counter[cave_name] -= 1
...
if __name__ == "__main__":
    ...
    paths_found = find_paths_from('start', paths, visit_counter)
